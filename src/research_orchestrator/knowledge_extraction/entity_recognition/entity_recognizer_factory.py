...
from src.research_orchestrator.knowledge_extraction.entity_recognition.entity_recognizer import EntityRecognizer
from src.research_orchestrator.knowledge_extraction.entity_recognition.ai_entity_recognizer import AIEntityRecognizer, AI_ENTITY_TYPES
from src.research_orchestrator.knowledge_extraction.entity_recognition.scientific_entity_recognizer import ScientificEntityRecognizer, SCIENTIFIC_ENTITY_TYPES
...
class EntityRecognizerFactory:
    ...
    def create_combined_recognizer(cls, 
        ...
        """
        from src.research_orchestrator.knowledge_extraction.entity_recognition.combined_entity_recognizer import CombinedEntityRecognizer
