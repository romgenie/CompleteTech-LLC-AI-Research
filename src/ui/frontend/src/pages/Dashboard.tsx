...
import { Paper as PaperType, PaperStatus } from '../types';
...
function Dashboard(): JSX.Element {
  ...
  const { 
    ...
    error: papersError 
  } = useFetch<PaperType[]>('/api/papers/recent', {
    method: 'GET'
