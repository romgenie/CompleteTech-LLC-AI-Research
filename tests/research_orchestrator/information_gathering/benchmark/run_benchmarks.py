#!/usr/bin/env python
"""
Script to run benchmarks for the information gathering components.

This script runs benchmark tests for the information gathering components
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run benchmarks for information gathering components")
    parser.add_argument("--component", "-c", choices=["search", "source", "quality", "all"],
...
def run_benchmark(component, output_dir, verbose=False, quick=False):
    ...
    component_map = {
        "search": "test_search_manager_performance.py",
        "source": "test_source_manager_performance.py",
        "quality": "test_quality_assessor_performance.py"
    }
...
def generate_html_report(report):
    ...
    <html>
    <head>
        <title>Information Gathering Benchmark Report</title>
        <style>
    ...
    <body>
        <h1>Information Gathering Benchmark Report</h1>
