...
from research_orchestrator.adapters.base_adapter import BaseAdapter
...
try:
    ...
    from knowledge_graph_system.core.models.ai_models import (
        AIModel, Dataset, Algorithm, Metric, Paper, Task, Benchmark,
        TrainedOn, EvaluatedOn, Outperforms, BasedOn, Cites
    )
    from knowledge_graph_system.core.utils.schema_utils import SchemaDefinition
