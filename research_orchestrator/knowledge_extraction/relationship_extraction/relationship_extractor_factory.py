...
from research_orchestrator.knowledge_extraction.relationship_extraction.relationship_extractor import RelationshipExtractor
from research_orchestrator.knowledge_extraction.relationship_extraction.pattern_relationship_extractor import PatternRelationshipExtractor, DEFAULT_RELATION_TYPES
from research_orchestrator.knowledge_extraction.relationship_extraction.ai_relationship_extractor import AIRelationshipExtractor, AI_RELATION_TYPES
...
class RelationshipExtractorFactory:
    ...
    def create_combined_extractor(cls, 
        ...
        """
        from research_orchestrator.knowledge_extraction.relationship_extraction.combined_relationship_extractor import CombinedRelationshipExtractor
